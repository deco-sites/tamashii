...
import { ProductDetailsPage } from "../../functions/vtexProductDetailsPage.ts";
    ...
    return (
        <>
            ...
            <section class="w-full bg-gray-100 flex flex-col lg:flex-row">
                ...
                <div class="px-4 w-full lg:w-1/2 bg-white border border-solid border-gray-300 flex flex-col">
                    <div class="flex flex-col mt-10">
                        ...
                        <h1 class="lg:text-3xl text-xl font-semibold  uppercase text-gray-800">
                    ...
                    <div className="border-b border-solid border-gray-300 flex flex-row justify-between items-center">
                    ...
                    {description && (
                        <div class="border-b border-solid border-gray-300 flex flex-col justify-center items-center">
